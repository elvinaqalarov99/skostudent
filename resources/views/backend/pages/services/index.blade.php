                        ...
                        <table class="table table-bordered table-hover dataTables-base" data-order="1">
                            ...
                            @foreach($services as $data)
                                <tr class="gradeX">
                                    ...
                                    <td class="text-right">
                                        <a href="{{ route('admin.services.edit', $data->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-pencil-square-o"></i></a>
                                        <a href="{{ route('admin.services.delete', $data->id) }}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
