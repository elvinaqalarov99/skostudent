                    ...
                    <div class="ibox-title">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('admin.faqs.index') }}" class="btn btn-w-m btn-default">Geri</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea  name="content[{{ $locale }}]" class="form-control {{ $errors->first('content.' . $locale) ? 'is-invalid' : '' }}" >{{ old('content.' . $locale) }}</textarea>
