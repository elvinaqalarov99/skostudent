                                ...
                                @foreach(config('app.locales') as $locale)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('name.' . $locale) }}" name="name[{{ $locale }}]" class="form-control {{ $errors->first('name.' . $locale) ? 'is-invalid' : '' }}" required>
                                ...
                                @foreach(config('app.locales') as $locale)
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" value="{{ old('position.' . $locale) }}" name="position[{{ $locale }}]" class="form-control {{ $errors->first('position.' . $locale) ? 'is-invalid' : '' }}" placeholder="Məsələn, Keçmiş Tələbə, Tələbə, Məzun">
                                ...
                                @foreach(config('app.locales') as $locale)
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="content[{{ $locale }}]" class="form-control {{ $errors->first('content.' . $locale) ? 'is-invalid' : '' }}" rows="5" required>{{ old('content.' . $locale) }}</textarea>
