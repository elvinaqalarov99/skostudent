                    ...
                    <div class="ibox-title">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-6 text-right">
                                <a href="{{ route('admin.features.index') }}" class="btn btn-w-m btn-default">Geri</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                               value="{{ old('title.' . $locale, $feature?->title?->$locale) }}" name="title[{{ $locale }}]"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div>
                                            <br>
                                            @if($feature->getFirstMediaUrl('file'))
                                                <ul class="list-group" style="flex-direction: row">
                                                    <li class="list-group-item" data-media-parent>
                                                        <a href="{{ $feature->getFirstMediaUrl('file') }}"
                                                           target="_blank">{{ $feature->getFirstMedia('file')->file_name }}</a>
                                                        <span class="badge badge-danger remove-media"
                                                              data-route="{{ route('admin.remove-media', ['id' => $feature->getFirstMedia('file')->id]) }}"
