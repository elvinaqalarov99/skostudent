        ...
        <div class="container">
            <div class="custom__row">
                <div class="left register">
                    ...
                    <div class="login__text">{!! setting('sign-up-today-to-try-it-for-free') !!}</div>
                    <div class="form__div">
                            ...
                            <div class="form__row">
                                <div class="col">
                                    <div class="form__group">
                                        <label class="form__label">{{ setting('full-name') }}</label>
                                        <input class="form__control" type="text" name="name" value="{{ old('name') }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form__group">
                                        <label class="form__label">{{ setting('username') }}</label>
                                        <input class="form__control" type="text" name="username" value="{{ old('username') }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form__group">
                                ...
                                <div class="col">
                                    <div class="form__group">
                                        <label class="form__label">{{ setting('phone') }}</label>
                                ...
                                <div class="col text-right">
                                    <button class="button__primary mw-210"><span>{{ setting('register') }}</span></button>
                                </div>
                            </div>
                        </form>
                        ...
                        <div class="no__register">{{ setting('already-have-an-account') }} <a href="{{ route('login') }}">{{ setting('sign-in-now') }}</a></div>
                    </div>
                </div>
                <div class="right"><img src="{{ setting('register-page-image') }}"></div>
            </div>
        </div>
    </main>
@endsection
