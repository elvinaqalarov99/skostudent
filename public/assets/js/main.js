...
(function ($) {
    ...
    var imJs = {
        ...
        textChanger: function () {
            let words = $("#fullText").attr('data-words');
            var blockLetters = new TimelineMax({paused: true}),
                ...
                letterTiming = 0.6,
                spaceTiming = 0.8,
                stringsArray = words ? words.split(',') : [],
                currentString = 0;
        ...
        vedioActivation: function (e) {
            $('#play-video, .play-video').on('click', function (e) {
                ...
                if (url) {
                    ...
                    $("#video-overlay, .video-overlay").append(`<iframe width="560" height="315" src="https://www.youtube.com/embed/${url}" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`);
                }
            });
